...
def display_guest_menu():
    print("\n====== List of Operations ======")
    print("1. Perform PUT operation")
    print("2. Perform GET operation")
    print("3. Request to UPGRADE to MANAGER")
    print("4. Exit")
...
def display_manager_menu():
    ...
    print("4. Perform SUPERPUT operation")
    print("5. Perform SUPERGET operation")
    print("6. Exit")
...
def login(client_socket):
    ...
    if response.startswith("\nLogin successful"):
        proceed = True
        role = response.split()[-1].lower().split(".")[-2]

    return username, proceed, role
...
def main():
    ...
    try:
        while True:
            ...
            if choice == "1":
                username, proceed, role = login(client_socket)
                ...
                username, proceed = signup(client_socket)
                username_entered = proceed
                if proceed:
                    whole_exit = False
                    while True:
